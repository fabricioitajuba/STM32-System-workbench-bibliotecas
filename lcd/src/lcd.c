...
// ***********************************************************************
// Posiciona o cursor na coordenada x,y (x - coluna , y - linha)
// ***********************************************************************
void lcd_gotoxy(unsigned char x, unsigned char y)
{
 ...
 if(y == 0)
 {
	 lcd_write(0x80+x);       // Set DDRAM address command
 }
 else if(y == 1)
 {
	 lcd_write(0xC0+x);       // Set DDRAM address command
 }
 else if(y == 2)
 {
	 lcd_write(0x90+x);       // Set DDRAM address command
 }
 else if(y == 3)
 {
	 lcd_write(0xD0+x);       // Set DDRAM address command
 }
}
